<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ImageManager.aspx.cs" Inherits="NewsWebsiteAdmin.ImageManager" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Home Main Image Management</h3>
    ...
    <div class="modal-dialog modal-lg">
     ...
     <script>
         ...
         function LoadLanguage()
         {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'ImageManager.aspx/LoadLanguage',
                 dataType: 'json',
         ...
         function GetAllVideo() {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'ImageManager.aspx/GetAllVideo',
                 dataType: 'json',
                 data: '{"id":"' + articleId + '"}',
                 contentType: 'application/json; charset=utf-8',
                 success: function (response) {
         ...
         function LoadArticle(id) {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'ImageManager.aspx/loadArticle',
                 dataType: 'json',
                 data: '{"id":"' + id + '"}',
                 contentType: 'application/json; charset=utf-8',
                 success: function (response) {
         ...
         function GetAllImages(articleId) {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'ImageManager.aspx/GetAllImage',
                 dataType: 'json',
                 data: '{"id":"' + articleId + '"}',
                 contentType: 'application/json; charset=utf-8',
                 success: function (response) {
         ...
         function updateImage()
         {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'ImageManager.aspx/updateImageSec',
                 dataType: 'json',
         ...
         $("#TbMainImage").on('click', '.imgedit', function () {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'ImageManager.aspx/EditImageMain',
                 dataType: 'json',
                 data: JSON.stringify(data),
                 contentType: 'application/json; charset=utf-8',
                 success: function (response) {
         ...
         function addImage(imgparth)
         {
             ...
             else
             {
                 $.ajax({
                     type: 'POST',
                     url: 'ImageManager.aspx/AddExsitingImageMain',
                     dataType: 'json',
                     data: JSON.stringify(data),
                     contentType: 'application/json; charset=utf-8',
                     success: function (response) {
         ...
         function loadMainImage(id)
         {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'ImageManager.aspx/GetAllMainImg',
                 dataType: 'json',
                 data: JSON.stringify(data),
                 contentType: 'application/json; charset=utf-8',
                 success: function (response) {
         ...
         $("#TbMainImage").on('click', '.imgdel', function () {
             ...
             if (r == true) {
                 $.ajax({
                     type: 'POST',
                     url: 'ImageManager.aspx/DeleteMainImage',
                     dataType: 'json',
         ...
         $("#mainform").on('submit', function (e) {
             ...
             if (imageAdd == "") {
                 ...
                 $.ajax({
                     type: 'POST',
                     url: 'ImageManager.aspx/saveNewImage',
                     dataType: 'json',
