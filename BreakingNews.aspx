<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BreakingNews.aspx.cs" Inherits="NewsWebsiteAdmin.BreakingNews" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="inputClientCompany">News</label>
                                <span>* </span>
                                <textarea id="News" class="form-control" rows="4" cols="50"></textarea>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#cateTaskSec").on('click', '#btnSave', function () {
                ...
                if ( language == "0" || News == "")
                {
                    swal("Language and News fields are required!");
                }
                else
                {
                    saveCate();
            ...
            function saveCate() {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'BreakingNews.aspx/saveCate',
                    dataType: 'json',
                    data: JSON.stringify(data),
                    contentType: 'application/json; charset=utf-8',
                    success: function (response) {
            ...
            function loadHomecategories(id) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'BreakingNews.aspx/GetAllNews',
                    dataType: 'json',
                    data: JSON.stringify(data),
                    contentType: 'application/json; charset=utf-8',
                    success: function (response) {
                        ...
                        $.each(myData, function () {
                            ...
                            $("#tblcatogerylist").append('<tr><td class = ' + this.id + '>' + this.news + '</td><td>' + this.Language + '</td><td id="order' + this.id + '">' + finDate + '</td><td>' + button + '</td></tr>');
                        });
            ...
            $("#tblcatogerylist").on('click', '.NoActive', function () {
                ...
                if (r == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'BreakingNews.aspx/UpdateActive',
                        dataType: 'json',
            ...
            $("#tblcatogerylist").on('click', '.activeY', function () {
                ...
                if (r == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'BreakingNews.aspx/UpdateActiveNo',
                        dataType: 'json',
